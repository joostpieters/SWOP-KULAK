...
public class DelegateTaskHandler extends Handler {
     ...
     */
    public DelegateTaskHandler(ProjectContainer manager, Clock clock, Auth auth, Acl acl, Database db) {
     ...
     */
    public DelegateTaskHandler(ProjectContainer manager, Clock clock, Auth auth, Acl acl, Database db, SimulatorCommand simulatorCommand)
    {
        super(auth, acl);
