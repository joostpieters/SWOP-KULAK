...
public class CreateTaskHandlerSimulator extends CreateTaskHandler {
	
	public CreateTaskHandlerSimulator(ProjectContainer manager, Auth auth, Acl acl, Database db)
	{
